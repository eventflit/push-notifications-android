...
import com.eventflit.pushnotifications.fcm.FCMMessagingService;
...
public class PushNotifications {
     ...
     */
    public static PushNotificationsInstance start(Context context, String appId) {
        instance = new PushNotificationsInstance(context, appId);
        instance.start();
        return instance;
    }
