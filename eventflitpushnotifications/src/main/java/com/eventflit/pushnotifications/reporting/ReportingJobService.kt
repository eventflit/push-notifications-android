...
import com.eventflit.pushnotifications.reporting.api.*

data class EventflitMetadata(
  ...
  override fun onStartJob(params: JobParameters?): Boolean {
    params?.let {
      ...
      if (extras != null) {
        ...
        val appId = PushNotificationsInstance.getAppId(this.applicationContext)
        if (appId != null) {
          ReportingAPI(appId).submit(
          ...
          log.w("Incorrect start of service: app id is missing.")
          return false
        }
      } else {
